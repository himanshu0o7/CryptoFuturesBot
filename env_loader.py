...
def load_env():
    ...
    if dotenv_path == "":
        raise FileNotFoundError(".env file not found. Please ensure it exists in your root directory.")
    ...
    if not api_key or not api_secret:
        raise ValueError("Missing CoinSwitch API credentials in .env. Please check the variable names and values.")
