...
def main():
    ...
    for signal in buy_signals:
        print(f"[BUY ] {signal['symbol']:10} | Change %: {signal['change_percent']:6.3f} | Vol: ${signal['quote_volume']:,.2f} | Last Price: {signal['last_price']}")

    print("========================= 📉 SELL SIGNALS 📉 =========================")
    for signal in sell_signals:
        print(f"[SELL] {signal['symbol']:10} | Change %: {signal['change_percent']:6.3f} | Vol: ${signal['quote_volume']:,.2f} | Last Price: {signal['last_price']}")
