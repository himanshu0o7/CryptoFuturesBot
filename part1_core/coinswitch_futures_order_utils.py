...
def place_futures_order(symbol, side, order_type, qty, price=None, trigger_price=None, reduce_only=False):
    ...
    try:
        ...
        logging.info(f"Order placed! Order ID: {data.get('order_id')}, Status: {data.get('status')}")
